...
def get_movies(category):
  ...
  get_movies_url = base_url.format(category,api_key) # fill the data respectivily
  ...
  with urllib.request.urlopen(get_movies_url) as url:
    ...
    get_movie_response = json.loads(get_movie_data) # change to dictonary using json load
